...
def summary(model, input_size, device="cuda"):
        ...
        f.write('Total params: {0:,}'.format(total_params))
        f.write("\n")
        print('Trainable params: {0:,}'.format(trainable_params))
        f.write('Trainable params: {0:,}'.format(trainable_params))
        f.write("\n")
        print('Non-trainable params: {0:,}'.format(total_params - trainable_params))
        f.write('Non-trainable params: {0:,}'.format(total_params - trainable_params))
        f.write("\n")
        print('----------------------------------------------------------------')
        f.write('----------------------------------------------------------------\n\n')
        # return summary
